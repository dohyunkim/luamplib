...
%\mplibexternalizename{figures/test-fig}\mplibexternalize
\begin{document}
...
\begin{mplibcode}[artifact]
   ...
   endfig;
\end{mplibcode}%
diameter:\ifdefined\Dia\Dia\fi bp.%
\begin{mplibcode}[off]
...
\mplibgroup{mymask}[asgroup="masking"]
  \mpfig[off,externalizedependson=-1]
    draw pic withcolor 1;
  \endmpfig
\endmplibgroup
\mpfig[alt=test general masking,externalizedependson=-2]
  draw image(
    for i=-7 upto 8 :
      fill unitsquare
...
\leavevmode\qquad\qquad but this is the best:
...
\endmpfig
\endmplibgroup
\mpfig[alt=shading test, adjust-BBox=-10bp 6bp -9bp 14bp, externalizemargin=14bp]
drawdot origin withpen pencircle scaled 2;
...
\endmpfig
←preview bug.
\mpfig[alt=testing the macro withadjustbbox, adjust-BBox=-1bp -8bp 0bp 0bp, externalizemargin=8bp]
